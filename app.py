...
- Example: With Italy as the reference (appearing at the intersection of the x and y axes in dashed white), Spain has an 11% higher average salary and a 7.4% lower cost of living. Pursuing FI in Spain is likely to be easier, on average, than in Italy. There are about 30 countries where achieving FI would likely be easier compared to Italy. There are about 30 different countries where it would likely be easier to pursue FI compared to Italy. 
"""
