...
instructions = """
Select a country from the dropdown menu to compare cost of living and salary differences. The red line represents the benchmark where differences are equal.
"""
