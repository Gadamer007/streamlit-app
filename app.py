...
- Hover over the top right of the figure and use the zoom (make a square on the figure), zoom in/out, pan, and other functions to better visualize your countries of interest.
- Example (Italy as reference, appears at the intersection of x and y axis in dashed white): Spain has a 11% higher average salary, yet a 7.4% lower cost of living. Pursuing FI in Spain is likely going to be easier, on average, than in Italy. There are about 30 different countries where it would likely be easier to pursue FI compared to Italy. 
"""
