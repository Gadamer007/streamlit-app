...
- The **red dashed line** serves as a benchmark:
   - Countries **above the red line** may provide better opportunities for pursuing financial independence during the accumulation phase.
   - Countries **on the red line** have equivalent percentage differences in both salaries and COL.
   - Countries **below the red line** may provide worse opportunities for pursuing financial independence during the accumulation phase.
   - Use the zoom in and other functions on the top right of the figure.
   - Example (Italy as reference): Spain has a 11% higher average salary, yet a 7.4% lower cost of living. Pursuing FI in Spain is likely going to be easier, on average, than in Italy. 
"""
