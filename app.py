...
st.write("### Cost of Living vs Salary Comparison")

instructions = """
Select a country from the dropdown menu to compare cost of living and salary differences.
The **red dashed line** serves as a benchmark where salary and cost of living differences are equal.
"""
...
def create_scatter_plot(data, reference_country):
    ...
    # Add diagonal red benchmark line
    fig.add_shape(
        type="line",
        x0=x_min - x_margin,
        y0=x_min - x_margin,
    ...
    # Slightly smaller bubbles and fix legend visibility
    fig.update_traces(
        marker=dict(size=10, line=dict(width=2, color='DarkSlateGrey')),  # Smaller bubble sizes
    ...
    fig.update_layout(
        ...
        height=550,  # Rectangular layout
        width=1200,  # Wider layout
