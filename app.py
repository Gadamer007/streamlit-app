...
- Example (Italy as reference): Spain has a 11% higher average salary, yet a 7.4% lower cost of living. Pursuing FI in Spain is likely going to be easier, on average, than in Italy. There are about 30 different countries where it would likely be easier to pursue FI compared to Italy. 
"""
