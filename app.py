...
def create_scatter_plot(data, reference_country):
    ...
    # Increase bubble size and fix legend visibility
    fig.update_traces(
        marker=dict(size=15, line=dict(width=2, color='DarkSlateGrey')),  # Larger bubble sizes
    ...
    fig.update_layout(
        ...
        height=600,  # Adjust height for a more rectangular plot
        width=1000,  # Increase width to make plot more horizontal
